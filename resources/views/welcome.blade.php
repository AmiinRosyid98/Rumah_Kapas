    ...
    <div class="container">
      ...
      -->
          ...
          @if(\Session::has('login'))
            <?php $id_cust = Session::get('id_cust');
            ...
            <li class="drop-down"><a href="#">{{Session::get('name')}}</a>
               <ul>
                ...
                <li><a href="#" onclick="myorder()">My Order <span class="label label-primary" style="float: right; background-color: red;color: white;padding:0px 7px; border-radius: 50%;">{{$jum_order}}</span></a></li>
