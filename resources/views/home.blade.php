  ...
  <section id="intro" class="clearfix">
    <div class="container">
      ...
      <div class="intro-info">
        <h2>Design<br><span>your</span> Own !</h2>
        <div>
  ...
  <main id="main">
    ...
    <section id="why-us" class="wow fadeIn">
      ...
      <div class="container">
        ...
        <header class="section-header">
          <h3>Desain your Clothes </h3>
          <p>Buat Sendiri pakaian sesuai keinginanmu !</p>
        </header>
        <!--
    ...
    <section id="portfolio" class="clearfix">
        ...
        <div class="row">
          <div class="col-lg-12">
            <ul id="portfolio-flters">
              ...
              @foreach ($jenis as $j)
              <li data-filter=".filter-{{$j->id_jenis}}">{{$j->jenis}}</li>
              @endforeach
            </ul>
          </div>
        </div>
      ...
      -->
          @foreach($tipe as $t)
          <div class="col-lg-3 col-md-6 portfolio-item filter-{{$t->id_jenis}}" data-wow-delay="0.1s">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/kemeja.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4><a href="#">{{$t->tipe}}</a></h4>
                <p>{{$t->jenis}}</p>
                <div>
                  <a href="assets/img/portfolio/kemeja.jpg" class="link-preview" data-lightbox="portfolio" data-title="Web 3" title="Preview"><i class="ion ion-eye"></i></a>
                  @if(\Session::has('login'))
                    <a href="{{$t->id_tipe}}" class="link-details" title="Pesan Sekarang " onclick="bahan('{{$t->id_tipe}}')" data-toggle="modal" data-target=".bd-example-modal-lg"><i class="ion ion-android-open"></i></a>
                    
                  @else
                    <a href="signin" class="link-details" title="Pesan Sekarang " ><i class="ion ion-android-open"></i></a>
                  @endif
                </div>
              </div>
            </div>
          ...
          @endforeach
           ...
           function bahan(id_tipe){
            
                //$("#loading").show(); // Tampilkan loadingnya          
                $.ajax({        
                  type: "POST", // Method pengiriman data bisa dengan GET atau POST        
                  url: "shipping_info/select_bahan", // Isi dengan url/path file php yang dituju        
                  ...
                  success: function(response){ // Ketika proses pengiriman berhasil          
                    ...
                    $("#tampil_bahan").html(response.tampil_bahan).show();        
                  },        
          ...
          <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Pilih Bahan</h5>
